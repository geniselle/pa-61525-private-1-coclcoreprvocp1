...
.Ambiente COCLHSHYPCBT1
image::OCP-4x-VMware-UPI/ocp-5-cluster-diagrams.png[pdfwidth=99%,width=99%]

== Componentes del Cluster de OpenShift
=== Servidor Bastión
Una estación de trabajo RHEL (bastión) para usar como jumpbox para nodos OCP y firmada e instalada con las utilidades de implementación y configuración de OpenShift. Esta estación de trabajo se utilizará para instalar y configurar el clúster OCP.
...
|10.32.75.245
a|
* api.COCLCOREPRVOCP1.corp.popular.local
* api-int.COCLCOREPRVOCP1.corp.popular.local
a|
* 6443
* 22623
...
* 10.32.75.43
|10.32.75.244
|*.apps.COCLCOREPRVOCP1.corp.popular.local
a|
* 80
* 443
...
* Para el cambio de los certificados del ingress, tener en cuenta los siguientes prerrequisitos:
    ...
    - El certificado debe incluir la extensión subjectAltName que muestra *.apps.COCLCOREPRVOCP1.corp.popular.local
...
|A/PTR
|COHVCAWNOPC01
|cohvcawnopc01.coclcoreprvocp1.corp.popular.local
|10.32.75.31

|A/PTR
|COHVCAWNOPC02
|cohvcawnopc02.coclcoreprvocp1.corp.popular.local
|10.32.75.32

|A/PTR
|COHVCAWNOPC03
|cohvcawnopc03.coclcoreprvocp1.corp.popular.local
|10.32.75.33

|A/PTR
|COHVCAWNOPC04
|cohvcawnopc04.coclcoreprvocp1.corp.popular.local
|10.32.75.34

|A/PTR
|COHVCAWNOPC05
|cohvcawnopc05.coclcoreprvocp1.corp.popular.local
|10.32.75.35

|A/PTR
|COHVCAWNOPC06
|cohvcawnopc06.coclcoreprvocp1.corp.popular.local
|10.32.75.36

|A/PTR
|COHVCAWNOPC07
|cohvcawnopc07.coclcoreprvocp1.corp.popular.local
|10.32.75.37

|A/PTR
|COHVCAWNOPC08
|cohvcawnopc08.coclcoreprvocp1.corp.popular.local
|10.32.75.38

|A/PTR
|COHVCAWNOPC09
|cohvcawnopc09.coclcoreprvocp1.corp.popular.local
|10.32.75.39

|A/PTR
|COHVCAWNOPC10
|cohvcawnopc10.coclcoreprvocp1.corp.popular.local
|10.32.75.40

|A/PTR
|COHVCIWNOPC01
|cohvciwnopc01.coclcoreprvocp1.corp.popular.local
|10.32.75.41

|A/PTR
|COHVCIWNOPC02
|cohvciwnopc02.coclcoreprvocp1.corp.popular.local
|10.32.75.42

|A/PTR
|COHVCIWNOPC03
|cohvciwnopc03.coclcoreprvocp1.corp.popular.local
|10.32.75.43

|A/PTR
|COHVCMANOPC01
|cohvcmanopc01.coclcoreprvocp1.corp.popular.local
|10.32.75.44

|A/PTR
|COHVCMANOPC02
|cohvcmanopc02.coclcoreprvocp1.corp.popular.local
|10.32.75.45

|A/PTR
|COHVCMANOPC03
|cohvcmanopc03.coclcoreprvocp1.corp.popular.local
|10.32.75.46

|A/PTR
|COHVCBANOPC01
|cohvcbanopc01.coclcoreprvocp1.corp.popular.local
|10.32.75.47

|A/PTR
|COHVCBSTOPC01
|cohvcbstopc01.coclcoreprvocp1.corp.popular.local
|10.32.75.72

|A/CNAME
|API
|api.coclcoreprvocp1.corp.popular.loca
|10.32.75.245
